...
const Product = () => {
    ...
    return (
        ...
        <div className="h-10 w-full bg-slate-500  dark:bg-red-300">
         ...
         {Data.length > 0 ? (
             <ul className=" grid  gap-5 grid-cols-1 md:grid-cols-2 lg:grid-cols-3 mt-20">
                 {Data.map((equipment) => (
                    <div key={equipment._id} className="card bg-slate-300  dark:bg-red-300 w-72 shadow-xl">
                    <figure>
                      <img
                    ...
                    <div className="card-body">
                      ...
                      <div className="card-actions justify-start">
                        <div className=""><Link to={`/details/${equipment._id}`}><button className="text-md font-semibold text-white
                          bg-slate-500  dark:bg-red-500 px-2 py-1 border-2 rounded-lg">Details</button></Link></div>
